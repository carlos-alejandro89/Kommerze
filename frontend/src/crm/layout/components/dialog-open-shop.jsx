                            ...
                            <div className="lg:col-span-8 space-y-6">
                                            ...
                                            <div className="mt-auto">
                                                <div className="bg-white/5 border border-white/10 rounded-xl p-4 backdrop-blur-md">
                                                    <div className="flex items-center gap-2 mb-3">
                                                        <Info className="size-3.5 text-blue-200/60" />
                                                        <span className="text-[9px] text-blue-200/60 uppercase font-black tracking-widest">Desglose de Ubicación</span>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4 text-xs">
                                                        <div className="flex flex-col gap-1">
                                                            <span className="text-blue-200/80 font-medium">Almacén:</span>
                                                            <span className="font-bold text-white tracking-wide">$1,120,500</span>
                                                        </div>
                                                        <div className="flex flex-col gap-1">
                                                            <span className="text-blue-200/80 font-medium">Piso Venta:</span>
                                                            <span className="font-bold text-white tracking-wide">$364,700</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="bg-card text-card-foreground rounded-xl p-6 shadow-sm border border-border flex flex-col">
                                        ...
                                        <div className="mt-auto space-y-2">
                                            <div className="flex justify-between items-center p-2.5 bg-muted/50 rounded-md">
                                                <span className="text-xs text-foreground font-medium">Billetes</span>
                                                <span className="text-xs font-bold text-foreground">$6,000.00</span>
                                            </div>
                                            <div className="flex justify-between items-center p-2.5 bg-muted/50 rounded-md">
                                                <span className="text-xs text-foreground font-medium">Monedas</span>
                                                <span className="text-xs font-bold text-foreground">$1,500.00</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-card text-card-foreground rounded-xl p-6 lg:p-8 border border-border shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
                                        ...
                                        <Button className="w-full sm:w-auto h-11 px-6 rounded-lg font-bold text-xs uppercase tracking-wider bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm flex items-center gap-2 group transition-colors">
                                            Confirmar Apertura
