        ...
        <div className="order-last grid shrink-0 grid-cols-2 overflow-hidden rounded-2xl border border-white/70 bg-white/70 shadow-[0_12px_32px_-27px_rgba(30,64,120,.42)] backdrop-blur-xl dark:border-white/10 dark:bg-white/[.045] xl:grid-cols-4">
          {summaryCards.map((card) => (
            <div key={card.label} className="flex min-h-[70px] items-center gap-3 border-l border-border/60 px-5 py-3 first:border-l-0">
              <div className={cn('flex size-10 shrink-0 items-center justify-center rounded-xl', card.bg)}>
                <card.icon className={cn('size-4.5', card.color)} strokeWidth={1.9} />
              </div>
              <div className="min-w-0">
                {loading
                  ? <div className="h-5 w-20 animate-pulse rounded-md bg-muted" />
                  : <p className="truncate text-base font-bold leading-5 tracking-[-0.025em] text-foreground">{card.value}</p>
                }
            ...
            <div className="flex min-w-0 flex-1 items-center justify-end gap-2">
              <div className="relative w-full max-w-md">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-xl border border-border/70 bg-background/75 pl-10 pr-4 text-sm text-foreground outline-none transition placeholder:text-muted-foreground/70 focus:border-primary/45 focus:ring-2 focus:ring-primary/10"
                />
              </div>
              <button
                type="button"
                ...
                className={cn(
                  'relative flex h-10 shrink-0 items-center gap-2 rounded-xl border px-3.5 text-xs font-semibold transition-colors',
                  advancedFilterCount
              ...
              <button
                onClick={cargar}
                disabled={loading}
                className="flex size-10 shrink-0 items-center justify-center rounded-xl border border-border/70 bg-background/75 text-muted-foreground transition-colors hover:border-primary/30 hover:bg-primary/5 hover:text-primary disabled:cursor-not-allowed disabled:opacity-40"
