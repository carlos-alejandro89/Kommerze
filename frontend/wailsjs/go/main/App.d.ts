...
export function NetPayAuthGetToken():Promise<dto.ResponseDto>;

export function NetPaySaleTransaction(arg1:services.NetPaySaleRequest):Promise<dto.ResponseDto>;
