...
type OperacionSucursal struct {
	...
	ValorBrutoVentas        decimal.Decimal `gorm:"type:decimal(18,6);default:0"`
	...
	TransferenciasEntrantes decimal.Decimal `gorm:"type:decimal(18,6);default:0"`
	TransferenciasSalientes decimal.Decimal `gorm:"type:decimal(18,6);default:0"`
